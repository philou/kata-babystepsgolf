# Getting Started with BabyStepsGolf kata in Rust
...
> ***Reminder***: the commands below should be run from [Kata-BabyStepsGolf/rust](.) directory
...
> ***Reminder***: the command below should be run from [Kata-BabyStepsGolf/rust](.) directory
...
`File` > `Open` > `Kata-BabyStepsGolf` > `rust`
...
Open Visual Studio Code, choose `Open Folder`, navigate to `Kata-BabyStepsGolf` / `rust`
